// useGridInteraction.js — pointer events, selection, hover, build ghost
(function() {
  const { ref } = Vue;

  function useGridInteraction(camera, gridWidth, gridHeight) {
    const hoverTile = ref(null);        // { gx, gy }
    const selectedBuilding = ref(null);  // building type string or null
  ...
  window.SpaceColony.useGridInteraction = useGridInteraction;
})();
